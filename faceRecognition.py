...
def login():
    ...
    os.replace(num1 + ".png", "Diem-danh/" + str(date_time) + "/" + num1 + ".png" )
...
tk.Label(loginFrame, text="Nhan dien khuon mat", font=("Courier", 60), bg="white").grid(row=1, column=1, columnspan=5)
loginButton = tk.Button(loginFrame, text="Diem danh", bg="Cyan", font=("Arial", 30), command=login)
loginButton.grid(row=2, column=5)
regButton = tk.Button(loginFrame, text="Dang ky", command=regFrameRaiseFrame, bg="green", font=("Arial", 30))
regButton.grid(row=2, column=1)

tk.Label(regFrame, text="Register", font=("Courier", 60), bg="white").grid(row=1, column=1, columnspan=5)
tk.Label(regFrame, text="Nhap MSSV : ", font=("Arial", 30), bg="white").grid(row=2, column=1)
nameEntry = tk.Entry(regFrame, textvariable=mssv, font=("Arial", 30)).grid(row=2, column=2)
tk.Label(regFrame, text="Nhap ten : ", font=("Arial", 30), bg="white").grid(row=3, column=1)
